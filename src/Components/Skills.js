import restLogo from "../images/django_rest.png";

const icons = [
  {
    id: 1,
    html: (
      <svg className="w-20 h-20 fill-black" viewBox="0 0 128 128">
        <path
          fill="#E44D26"
  ...
  },
  {
    id: 2,
    html: (
      <svg className="w-20 h-20" viewBox="0 0 128 128">
        <path
          fill="#1572B6"
  ...
  },
  {
    ...
    html: (
      <svg
        className="w-20 h-20 fill-sky-600"
        fill="currentColor"
        viewBox="0 0 128 128"
      >
        <path
  ...
  },
  {
    id: 4,
    html: (
      <div className="flex  bg-yellow-400 rounded-full p-3 w-20 h-20">
        <div className="my-auto mx-auto flex gap-x-1">
          <p className="text-5xl  text-white font-extrabold">J</p>
          <p className="text-5xl  text-white font-extrabold">S</p>
        </div>
      </div>
    ),
  ...
  },
  {
    id: 5,
    html: (
      <svg className="w-20 h-20 fill-sky-500" viewBox="0 0 128 128">
        <g fill="#0ea5e9">
...
export default function Skills() {
  return (
    <div className="bg-emerald-300 dark:bg-gray-800  py-8">
      <div className="mx-4 sm:mx-28 md:mx-40 lg:mx-60  py-4   dark:bg-gray-900 rounded-md">
        <div className="flex flex-col gap-y-8">
          ...
          <div className=" grid grid-cols-3 sm:grid-cols-3 md:grid-cols-4 grid-flow-row  gap-x-8 gap-y-6 ">
            {icons.map((icon) => (
              <div key={icon.id} className="flex flex-col gap-y-2">
                <span className="mx-auto">{icon.html}</span>
